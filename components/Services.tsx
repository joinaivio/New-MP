    ...
    <section id="services" className="py-20 md:py-28 bg-white" ref={sectionRef}>
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12 md:mb-16">
          <img src="https://drive.google.com/uc?export=view&id=1pfatxNSNS0BsbA5IJaN2uYg675JEv_qc" alt="Master P Barbershop Logo" className="mx-auto h-20 md:h-24 w-auto mb-8 drop-shadow-md animate-on-scroll"/>
